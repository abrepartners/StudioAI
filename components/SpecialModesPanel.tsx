                        ...
                        if (canBatch) {
                            ...
                            const doCleanup = () => run('declutter', async (signal) => {
                                ...
                                try {
                                    ...
                                    // Re-enable composite for Flux with tuned params:
                                    // threshold 0.05 catches subtle re-renders on carpet/walls,
                                    // dilatePx 2 keeps Flux's crisp edges without over-dilating.
                                    // Original pixels win everywhere Flux didn't change.
                                    const result = await postProcessToolOutput(
                                        resultBase64,
                                        input,
                                        'cleanup',
                                        FLUX_CLEANUP_COMPOSITE_OPTIONS,
                                    );
